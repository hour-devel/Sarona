...
const LoginComponent = () => {
  ...
  return (
    <div>
      ...
      <div className="2xl:w-[500px] xl:w-[500px] lg:w-[500px] w-[91%] bg-white rounded-[40px] absolute 2xl:left-[48%] 
      xl:left-[35%] lg:left-[20%] left-[5%] 2xl:top-[50%] xl:top-[50%] lg:top-[50%] top-[50%] translate-y-[-55%] 2xl:py-[30px] 
      2xl:px-[40px] xl:py-[30px] xl:px-[40px] py-[40px] px-[20px] shadow-sd ">
        ...
        <form onSubmit={handleSubmit(handleLogin)}>
          ...
          >
            ...
            >
              <path
                fill="#FFC107"
                d="M43.611,20.083H42V20H24v8h11.303c-1.649,4.657-6.08,8-11.303,8c-6.627,0-12-5.373-12-12c0-6.627,5.373-12,12-12c3.059,0,5.842,1.154,
                7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4C12.955,4,4,12.955,4,24c0,11.045,8.955,20,20,20c11.045,0,20-8.955,20-20C44,22.659,
                43.862,21.35,43.611,20.083z"
              ></path>
              <path
                fill="#FF3D00"
                d="M6.306,14.691l6.571,4.819C14.655,15.108,18.961,12,24,12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4C16.318,
                4,9.656,8.337,6.306,14.691z"
              ></path>
              <path
                fill="#4CAF50"
              ...
              <path
                fill="#1976D2"
                d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,
