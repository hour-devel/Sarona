      ...
      <div className="w-[50%] mt-[15px] float-left p-[5px]">
        ...
        <InputComponent
          ...
          icon={
            ...
            >
              <path
                d="M13 4.0625C9.86781 4.0625 7.3125 6.61781 7.3125 9.75C7.3125 11.7081 8.31187 13.4469 9.82638 14.4731C6.92819 15.7162 4.875 18.5924 4.875 21.9375H6.5C6.5 18.3381 9.40063 15.4375 13 15.4375C16.5994 15.4375 19.5 18.3381 19.5 21.9375H21.125C21.125 18.5924 19.0718 15.717 16.1736 14.4722C16.9466 13.9504 17.5799 13.2472 18.0182 12.4239C18.4564 11.6007 18.6862 10.6826 18.6875 9.75C18.6875 6.61781 16.1322 4.0625 13 4.0625ZM13 5.6875C15.2531 5.6875 17.0625 7.49694 17.0625 9.75C17.0625 12.0031 15.2531 13.8125 13 13.8125C10.7469 13.8125 8.9375 12.0031 8.9375 9.75C8.9375 7.49694 10.7469 5.6875 13 5.6875Z"
                fill="#999999"
              />
            </svg>
          }
