...
const EditDraftEventComponent = ({
  ...
  async function handleSubmit() {
    ...
    const formData = {
      eventTitle: eventTitle || eventData.eventTitle,
    ...
    const eventDATA = await editEventDraftByEventIdAction(eventId, formData);
        ...
        <ModalContent className="min-w-[535px]">
          ...
          <ModalBody className="relative">
            ...
            <Textarea
              ...
              placeholder={eventData?.eventDescription}
...
export default EditDraftEventComponent;
