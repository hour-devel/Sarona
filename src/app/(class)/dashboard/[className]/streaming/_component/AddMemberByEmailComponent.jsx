...
const AddMemberByEmailComponent = ({ classID }) => {
  const roleData = [
  ...
  async function handleInviteMember() {
    ...
    } else if (inviteMember?.statusCode == 200) {
  ...
  return (
    <div className="absolute top-[17%] right-[25px] w-[350px] z-30 rounded-2xl float-left shadow-[#C2C3C3_0px_0px_3px] ml-[625px] bg-white  mt-[45px]">
...
export default AddMemberByEmailComponent;
