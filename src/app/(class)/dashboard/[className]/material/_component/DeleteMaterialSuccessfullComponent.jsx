...
const DeleteMaterialSuccessfulComponent = ({ comfirmPopup }) => {
  return (
    <div>
      <Modal isOpen={true}>
        <ModalContent className="max-w-[25%] h-auto mt-3 flex flex-col justify-center items-center">
          ...
          <ModalFooter className="mb-[20px]">
            <Button onClick={() => comfirmPopup(false)} className="bg-primary border-2 text-white">
              OK
            </Button>
          </ModalFooter>
        </ModalContent>
...
export default DeleteMaterialSuccessfulComponent;
