...
import { deleteMaterialByIdAction, getAllMaterialsBySubjectIdAction } from '@/action/materialAction';
                        ...
                        {isLoading ? (<div className="flex justify-center items-center w-full h-full">
                            ...
                            <div>
                                <div className='ml-[30px] mb-[20px]'>
                                    ...
                                    {isOpenFormCreateMaterial && <FormCreateMaterialComponent
                                ...
                                <div className="w-[100%] h-[60%] overflow-hidden pl-[30px] pb-[20px]">
                                    <div className=" justify-evenly items-center cursor-pointer pb-[20px]">
                                        <div className='grid grid-cols-2'>
                                            {materialData && materialData.payload && materialData.payload.length > 0 ? (
                                                materialData.payload.map((e, index) => (
                                                    ...
                                                    >
                                                        <div className="w-[80%] h-[100%] flex">
                                                            <div className={`w-[9px] h-[100%] bg-[#C3E0FA] mr-[7%]`}></div>
                                                            <div className="w-[70%] h-[100%] flex items-center">
                                                                <div className={`w-[38.86px] bg-[#C3E0FA] h-[40px] rounded-[12px] flex justify-center items-center`}>
                                                                    <Image src={IconLink} className="object-cover" alt="Material Icon" />
                                                                </div>
                                                                <div className="w-[70%] h-[35px] ml-[8px]">
                                                                    ...
                                                                    <div className="flex mt-1">
                                                                        ...
                                                                        <p className="p[4px] w-[40px] bg-[#C3E0FA] text-primary text-[10px] text-center rounded-lg line-clamp-1 p-[1] lowercase">
                                                                            {cutStringIntoChunks(e?.subjectInfo.subjectName)}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div className="w-[8%] h-[100%] mt-3 flex justify-center items-start">
                                                            <Dropdown className="min-w-[120px]">
                                                                ...
                                                                <DropdownMenu aria-label="Static Actions">
                                                                    <DropdownItem key="edit" className="data-[hover=true]:bg-blue-200">
                                                                        <button
                                                                            className="flex"
                                                                            onClick={() => {
                                                                    ...
                                                                    <DropdownItem key="download" className="border-t-1 border-gray-200 data-[hover=true]:bg-blue-200">
                                                                        <div className="flex">
                                                                            <Image src={IconDownload} alt="Download" />
                                                                            <a className="ml-[8px]" >
                                                                                {e?.materialLinks[0]?.fileUrl ? <Link href={e?.materialLinks[0]?.fileUrl} target='_blank'
                                                                                    className='text-black text-[14px]'>Download</Link> : "No file upload"}
                                                ...
                                                <p className='text-[14px] absolute top-12 left-[42%]'>No materials available.</p>
                                            )}
                                        </div>
                                        {isOpen &&
